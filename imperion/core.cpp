...
{
    QDir dir(qApp->applicationDirPath());
    QFile file(dir.absoluteFilePath("system.lic"));

    QString hwKey = getMacAddress();

    QString enkode = QString( QCryptographicHash::hash(hwKey.toLocal8Bit(), QCryptographicHash::Sha256).toHex());
