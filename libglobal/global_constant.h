...
namespace CONSTANT {
    const QString APP_NAME          = QStringLiteral("Imperion");
    const QString WINDOW_TITLE      = QStringLiteral("%1 - Imperion");
    const QString ABOUT_APP_NAME    = QStringLiteral("Imperion %1");
    const QString URL_UPDATE        = QStringLiteral("https://imperionupdate.zukino.com/check?arc=%1&qt=%2");
    const QString URL_DOWNLOAD      = QStringLiteral("https://imperionupdate.zukino.com/assets/upload/imperion_%1_%2_%3");
    const QString BARCODE_CLOUD     = QStringLiteral("https://barcode.indoarm.com/?barcode=%1");
}

namespace GOOGLE {
    const QString CLIENT_ID         = QStringLiteral("191495074532-hgsjk2ioojf9dg7c32j2q83h8sif4dkt.apps.googleusercontent.com");
    const QString CLIENT_SECRET     = QStringLiteral("rVt7kIeeQpgkZZ2Payl2j8zS");
}
