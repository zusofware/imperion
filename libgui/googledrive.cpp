...
static QString G_GET_FOLDER{"https://www.googleapis.com/drive/v3/files?q=mimeType=\"application/vnd.google-apps.folder\" and name=\"imperionbackup\" and trashed=false"};
...
void GoogleDrive::createFolder()
{
    QNetworkRequest req;
    req.setUrl(G_FILES);
    QByteArray jsonString = "{\"name\":\"imperionbackup\",\"mimeType\":\"application/vnd.google-apps.folder\"}";
...
void GoogleDrive::uploadFileExec()
{
    ...
    data.append("--imperion_boundary\nContent-Type: application/json; charset=UTF-8\n\n{ \"name\": \"");
    data.append("imperion" + QDateTime::currentDateTime().toString("-yyyyMMdd-hhmmss") + "\", \"parents\": [\"");
    ...
    QNetworkRequest req;
    req.setUrl(G_UPLOAD);
    req.setRawHeader("Content-Type", "multipart/related; boundary=imperion_boundary");
