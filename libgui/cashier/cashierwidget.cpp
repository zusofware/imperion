    ...
    mAddItemDialog(new AddItemUnavailableDialog(bus, this))
{
    ...
    ui->labelTitle->setText(Preference::getString(SETTING::MARKET_NAME, "Imperion Minimarket"));
    ui->labelSubtitle->setText(GuiUtil::toHtml(Preference::getString(SETTING::MARKET_SUBNAME, "Gabuswetan\nIndramayu")));
...
void CashierWidget::printBill(const QVariantMap &data)
{
    ...
    const QString &title = Preference::getString(SETTING::PRINTER_CASHIER_TITLE, "Imperion Minimarket");
    const QString &subtitle = Preference::getString(SETTING::PRINTER_CASHIER_SUBTITLE, "Gabuswetan, Indramayu");
