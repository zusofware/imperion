...
{
    ui->lineAppName->setText(Preference::getString(SETTING::MARKET_NAME, "Imperion Minimarket"));
    ui->plainSubName->setPlainText(Preference::getString(SETTING::MARKET_SUBNAME, "Gabuswetan\nIndramayu"));
...
void SettingWidget::setupPrinter()
{
    ...
    ui->linePrintCashierTitle->setText(Preference::getString(SETTING::PRINTER_CASHIER_TITLE, "Imperion Minimarket"));
    ui->plainPrintCashierSubtitle->setPlainText(Preference::getString(SETTING::PRINTER_CASHIER_SUBTITLE, "Gabuswetan, Indramayu"));
...
void SettingWidget::printTestClicked()
{
    ...
    e.cpi10()->leftText("IMPERION TEST PAGE", true)->newLine()->line();
